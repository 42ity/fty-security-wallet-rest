/*  =========================================================================
    fty_security_wallet_rest_classes - private header file
...
#ifndef FTY_SECURITY_WALLET_REST_CLASSES_H_INCLUDED
#define FTY_SECURITY_WALLET_REST_CLASSES_H_INCLUDED
